...
function News() {
  return (
    <div className="flex flex-col w-full bg-gray-100">
      <p className="text-center text-2xl text-black mt-4">
        ثبت نام در خبرنامه بانی مد
      </p>
      <p className="text-center text-base mt-2 text-medium">
      ...
      <div className="flex w-2/3 py-2 px-4  bg-white rounded-full  self-center flex-row  mt-6">
        <div className="flex w-1/5 flex-row h-14 rounded-full bg-green-500 mr-4 px-4 items-center">
          <img
            ...
            className="w-4 h-2 rounded-4 rotate-180"
          ></img>
          <p className="text-white text-base text-right flex-1 ">ارسال</p>
        </div>
